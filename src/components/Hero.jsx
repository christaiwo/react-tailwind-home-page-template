import { CloudArrowUpIcon, CircleStackIcon, PaperAirplaneIcon, ServerIcon } from '@heroicons/react/20/solid';
  ...
  return (
    <div name='home' className="w-full h-screen bg-zinc-200 flex flex-col justify-between">
        <div className="grid md:grid-cols-2 max-w-[1240px] mx-auto lg:mt-20">
            ...
            <div>
                <img src={bgImg} alt="bg-image" className='w-full' />
            </div>
            <div className='absolute flex flex-col py-8 min-w-full md:min-w-[760px] bottom-[-5%] md:mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl'>
                <p>Data Services</p>
