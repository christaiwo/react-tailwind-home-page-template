    ...
    <div name='pricing' className='w-full text-white my-24'>
        ...
        <div className='max-w-[1240px] mx-auto py-12'>
            <div className='text-center py-8 text-slate-300'>
                ...
                <p className='text-3xl'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A esse id rem, dicta, quia explicabo at possimus ab consectetur neque delectus sed libero impedit repellat? Eveniet tempora nesciunt quis consequatur.</p>
            </div>
            <div className='grid md:grid-cols-2'>
                <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                    ...
                    <p className='text-2xl py-8 text-slate-500'> 
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut itaque illo voluptas, 
                    </p>
